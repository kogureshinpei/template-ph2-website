...
<body>
  ...
  <main class="l-main">
    ...
    <!-- /.p-hero .p-quiz-hero -->
<a href="./admin/index.php">aaaaaaaaaa</a>
    ...
    <ul class="p-quiz-box__answer__list">
      <?php foreach ($questions[$i]["choices"] as $choice) { ?>
        <li class="p-quiz-box__answer__item">
          <button
            class="p-quiz-box__answer__button js-answer"
...
<div class="p-quiz-box__answer__correct js-result">
  <!-- <div id="js-quizContainer"></div> -->
  <p class="__title js-answerTitle"></p>
  <p class="p-quiz-box__answer__correct__content"></p>
